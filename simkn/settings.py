"""
Django settings for simkn project.
...
SECRET_KEY = 'django-insecure-2iv)^)s@vsh4q@of*gba&8ew)$co5&+5rt@hd$s&4ht5u8p$(r'
...
ROOT_URLCONF = 'simkn.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'examination' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'simkn.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "hide_models": ["examination.PETProcedure", 
